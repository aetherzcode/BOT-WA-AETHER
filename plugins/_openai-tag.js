    ...
    try {
        ...
        if (m.mentionedJid && m.mentionedJid.length > 0) {
            ...
            if (isMention) {
                ...
                */
                const messages = [
                    { role: "system", content: "kamu adalah AETHERZ, Seorang Asisten pribadi yang di buat oleh AETHER yang siap membantu kapan pun, jawab setiap pertanyaan menggunakan emoticon dan seramah mungkin kepada user jangan lupa sertakan lelcuon pada jawaban yang membuat user betah:)!" },
